...
<body class="stretched side-push-panel">
    ...
    <?php include('default/header.php');?>
		<section id="slider" class="slider-element dark parallax include-header include-topbar" style="background-image: url('<?= base_url('assets/')?>demos/real-estate/images/single-condo.jpg'); background-size: cover; height: 550px;" data-bottom-top="background-position:0px 200px;" data-top-bottom="background-position:0px -200px;">
				...
				<div class="real-estate-info-wrap">
					<div class="heading-block mb-0 border-bottom-0 d-md-flex d-block align-items-center justify-content-between">
						...
						<div class="d-flex flex-shrink-1" data-lightbox="gallery">
							<a href="<?= base_url('assets/')?>demos/real-estate/images/hero/4.jpg" class="button button-color button-rounded nott m-0 fw-medium align-self-end" data-lightbox="gallery-item"><i class="icon-picture"></i> View Gallery</a>
							<a href="<?= base_url('assets/')?>demos/real-estate/images/hero/2.jpg" class="d-none" data-lightbox="gallery-item"></a>
							<a href="<?= base_url('assets/')?>demos/real-estate/images/hero/3.jpg" class="d-none" data-lightbox="gallery-item"></a>
							<!--<a href="https://www.youtube.com/watch?v=GU58qaKmZhQ" data-lightbox="iframe" class="button button-color button-rounded nott fw-medium align-self-end my-0 ms-2"><i class="icon-play"></i> Play Video</a>-->
						</div>
					</div>
					...
					<div class="container clearfix">
						<div class="row">
							<div class="col-md-2 col-6 center">
								<img src="<?= base_url('assets/')?>demos/real-estate/images/user.jpg" alt="Image" class="img-circle" style="width: 60px; height: 60px;">
								<h5 class="my-2"><a href="#">Reeva Developers<span class="text-muted fw-normal" style="font-family: 'Roboto'">Host</span></a></h5>
							</div>
							<div class="col-md-2 col-6 center">
				...
				<div class="container clearfix">
					<div class="row gutter-40 col-mb-80">
						<div class="postcontent col-lg-9">
							...
							<h4 class="mb-0 topmargin">Sepicification</h4>
							<div class="line line-sm mt-1 mb-3"></div>
							<div class="row clearfix">
								<div class="col-md-4">
									<ul class="iconlist">
										<li class="mb-1"><i class="icon-line2-check"></i>Construction year: 2021</li>
										...
										<div id="comment-1" class="comment-wrap clearfix">
											<div class="comment-meta">
												<div class="comment-author vcard">
													...
													<img alt='Image' src='<?= base_url('assets/')?>demos/real-estate/images/user.jpg' class='avatar avatar-60 photo avatar-default' height='60' width='60' /></span>
												</div>
											</div>
											...
											<li class="comment byuser comment-author-_smcl_admin odd alt depth-2" id="li-comment-3">
												<div id="comment-3" class="comment-wrap clearfix">
													<div class="comment-meta">
														<div class="comment-author vcard">
															<span class="comment-avatar clearfix">
															<img alt='Image' src="<?= base_url('assets/')?>images/Reeva_Developers.png" class='avatar avatar-40 photo' height='40' width='40' /></span>
														</div>
													</div>
													<div class="comment-content clearfix">
										...
										<div class="card bg-light">
											...
											<div class="card-body"> 
												<form     action="<?= site_url('form/contact_us');?>" method="post" class="form-submit mb-0">
													<input type="text" class="form-control input-block-level"   name="name" value="" placeholder="Full Name" />
													<input type="text" class=" form-control email input-block-level"  name="email" value="" placeholder="Email Address" />
													<input type="number" class="form-control number input-block-level"  name="mobile" value="" placeholder="Phone Number" />
													...
													<button type="submit"   class="button  button-rounded w-100 m-0" value="submit">Book Now</button>
												</form>
											</div>
										</div>
									</div>
					...
					<div class="row col-mb-50">
						<div class="real-estate-item col-md-6 col-xl-4">
							<div class="real-estate-item-image">
								...
								<a href="#">
									<img src="<?= base_url('assets/')?>demos/real-estate/images/items/1.jpg" alt="Image 1">
								</a>
								<div class="real-estate-item-price">
									$1.2m<span>Leasehold</span>
								</div>
								<div class="real-estate-item-info clearfix" data-lightbox="gallery">
									<a href="<?= base_url('assets/')?>demos/real-estate/images/items/1.jpg" data-bs-toggle="tooltip" title="Images" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
									<a href="<?= base_url('assets/')?>demos/real-estate/images/items/3.jpg" class="d-none" data-lightbox="gallery-item"></a>
						...
						<div class="real-estate-item col-md-6 col-xl-4">
							<div class="real-estate-item-image">
								...
								<a href="#">
									<img src="<?= base_url('assets/')?>demos/real-estate/images/items/2.jpg" alt="Image 2">
								</a>
								<div class="real-estate-item-price">
						...
						<div class="real-estate-item col-md-6 col-xl-4">
							<div class="real-estate-item-image">
								...
								<a href="#">
									<img src="<?= base_url('assets/')?>demos/real-estate/images/items/3.jpg" alt="Image 3">
								</a>
								<div class="real-estate-item-price">

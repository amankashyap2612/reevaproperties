...
<body>
                        ...
                        <div class="page-title-wrapper">
                            ...
                            <div class="page-title-actions">
                                 <ol class="breadcrumb float-end p-2">
                                    ...
                                    <li class="p-l-5"><a href="#">Facility</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
					<div class="tabs-animation">
						<form action="<?= site_url('web-admin/facility');?>" method="get">
							<div class="row">
								<div class="col-md-6">
						...
						<table class="table table-hover table-striped table-bordered mt-4">
							...
							<tbody>
								<?php $i=1; foreach($facility as $obj){ ?>
								<tr>
									<td><?=$i++;?></td>
									<td><?=$obj->name;?></td>
									<td><?= date('Y-m-d H:i:s',strtotime($obj->insert_time)); ?></td>
									<td><?= date('Y-m-d H:i:s',strtotime($obj->last_update)); ?></td>
									<td><?=$user_info[$obj->update_by]->f_name;?></td>
									<td id="Object-<?=$obj->id;?>">
									<?php if(in_array('3',$other_action)){ ?>
										<a href="#" data-url="<?=site_url('/web-admin/facility/change_facility_status');?>" data-id="<?=$obj->id;?>" data-status="<?=$obj->status;?>" class="change-status btn btn-primary"><?=($obj->status=="A")?'Deactive':'Active'?></a>
									<?php } ?>
									</td>
									<td>
		...
		<div class="modal-dialog modal-lg modal-full">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-submit" action="<?=site_url('web-admin/facility/add_facility');?>">
						<div class="row">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 form-group">
								...
								<button type="submit" class="btn btn-success form-control">Add facility</button>
							</div>
						</div>
					</form>
				</div>
	...
	<div class="modal fade" id="editObject" role="dialog">
		<div class="modal-dialog modal-lg modal-full">
			<div class="modal-content">
				<div class="modal-header">
					<p class="modal-title">Update Facility</p>
					<button type="button" class="close" data-bs-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-sm-12 attach-details">
							<form class="form-submit" action="<?=site_url('web-admin/facility/update_facility')?>">
								<div class="row">
									<div class="col-md-12 col-sm-12 form-group" >
										<label>Name</label>
										<input type="text" name="edt_name" class="form-control" placeholder="Facility Name">
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 col-sm-12 form-group">

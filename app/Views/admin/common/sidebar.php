    ...
    <div class="scrollbar-sidebar">
        <div class="app-sidebar__inner">
            <ul class="vertical-nav-menu">
                ...
                <li class="mm-active">
                    <a href="<?= site_url('web-admin/dashboard'); ?>">
                        <i class="metismenu-icon fa fa-tachometer"></i>Dashboard
                    </a>
                </li>
                <?php if(isset($tab)){ foreach($tab as $grp => $val){ ?>
                    ...
                    <?php asort($val['menu']); foreach($val['menu'] as $name => $url){ ?>
                        <li>
							<a href="<?= site_url('web-admin/'.$url); ?>"><i class="metismenu-icon"></i><?=ucfirst($name);?></a></li>
                    <?php } ?>
                    </ul>
                <?php } } ?>
                <li class="mm-active "> 
                    <li><a href="<?= site_url('web-admin/logout'); ?>"><i class="metismenu-icon fa fa-sign-out"></i> Logout</a></li>
                </li>
            </ul>
        </div>
    </div>
